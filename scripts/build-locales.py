...
for code, (name, native, d) in langs.items():
    d = {**d, **V3.get(code, {}), **V4.get(code, {}), **V5.get(code, {}), **V6.get(code, {}), **V7.get(code, {}), **V8.get(code, {}), **V9.get(code, {}), **V10.get(code, {}), **V11.get(code, {}), **V12.get(code, {}), **V13.get(code, {}), **V14.get(code, {})}
    out = {}
    for k, v in d.items():
        if ph(k) != ph(v):
