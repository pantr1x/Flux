...
export const TEMPLATES = [
  ...
  { id: 'js', label: 'JavaScript', detail: '.js (runs with Node.js)', name: 'script.js', files: [{ name: '{{name}}', content: "console.log('Hello!');\n$0" }] },
  {
    id: 'java-main',
    label: 'Java program',
    detail: 'Main.java with main()',
    name: 'Main.java',
    files: [{ name: '{{name}}', content: 'public class Main {\n    public static void main(String[] args) {\n        System.out.println("Hello from Java!");\n        $0\n    }\n}\n' }],
  },
  {
    id: 'c-main',
    label: 'C program',
    detail: 'main.c with printf',
    name: 'main.c',
    files: [{ name: '{{name}}', content: '#include <stdio.h>\n\nint main(void) {\n    printf("Hello from C!\\n");\n    $0\n    return 0;\n}\n' }],
  },
  {
    id: 'cpp-main',
    label: 'C++ program',
    detail: 'main.cpp with cout',
    name: 'main.cpp',
    files: [{ name: '{{name}}', content: '#include <iostream>\n\nint main() {\n    std::cout << "Hello from C++!" << std::endl;\n    $0\n    return 0;\n}\n' }],
  },
  {
    id: 'go-main',
    label: 'Go program',
    detail: 'main.go',
    name: 'main.go',
    files: [{ name: '{{name}}', content: 'package main\n\nimport "fmt"\n\nfunc main() {\n\tfmt.Println("Hello from Go!")\n\t$0\n}\n' }],
  },
  {
    id: 'cs-main',
    label: 'C# program',
    detail: 'Program.cs (.NET 10)',
    name: 'Program.cs',
    files: [{ name: '{{name}}', content: 'Console.WriteLine("Hello from C#!");\n$0\n' }],
  },
  {
    id: 'rs-main',
    label: 'Rust program',
    detail: 'main.rs',
    name: 'main.rs',
    files: [{ name: '{{name}}', content: 'fn main() {\n    println!("Hello from Rust!");\n    $0\n}\n' }],
  },
  {
    id: 'rb-main',
    label: 'Ruby script',
    detail: 'main.rb',
    name: 'main.rb',
    files: [{ name: '{{name}}', content: 'puts "Hello from Ruby!"\n$0\n' }],
  },
  {
    id: 'php-main',
    label: 'PHP script',
