...
contextBridge.exposeInMainWorld('flux', {
  ...
  lanUpdate: (state) => ipcRenderer.send('lan:update', state),
  onLanPeers: on('lan:peers'),
  ...
  pluginReviews: (id) => ipcRenderer.invoke('plugins:reviews', id),
  pluginReview: (id, stars, text) => ipcRenderer.invoke('plugins:review', id, stars, text),
  pluginDeleteComment: (commentId) => ipcRenderer.invoke('plugins:delete-comment', commentId),
  ...
  hideProject: (dir, hidden) => ipcRenderer.invoke('project:hide', dir, hidden),
  ...
  shellKill: () => ipcRenderer.send('shell:kill'),
  onShellData: on('shell:data'),
  onShellExit: on('shell:exit'),
